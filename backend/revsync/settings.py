"""
Django settings for RevSync project.
"""
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'RevSync API',
    'DESCRIPTION': 'Motorcycle Tuning Platform API',
    'VERSION': '1.0.0',
...
# Logging - Disabled for initial setup
# LOGGING = {
#     'version': 1,
...
# RevSync Specific Settings
REVSYNC_SETTINGS = {
    'MAX_TUNE_FILE_SIZE': 5 * 1024 * 1024,  # 5MB
    'SUPPORTED_TUNE_FORMATS': ['.bin', '.hex', '.ecu', '.map'],
