      ...
      >
        ...
        >
          {[
            ...
            },
            {
              ...
              label: "Privacy Mode",
              state: privacyMode,
              setState: setPrivacyMode,
            },
          ].map(({ icon, label, state, setState }) => (
            <IntelligentCard
              key={label}
              style={{
                flex: 1,
            ...
            >
              <Icon name={icon} size={22} color={Theme.colors.accent.primary} />
              <SettingsRow
                label={label}
                right={<Switch value={state} onValueChange={setState} />}
              />
            </IntelligentCard>
          ))}
        </View>
        ...
        >
          ...
          <SettingsRow
            ...
            right={
              <Text>
                {layoutDensity.charAt(0).toUpperCase() +
                  layoutDensity.slice(1)}
              </Text>
            }
          />
        </IntelligentCard>
