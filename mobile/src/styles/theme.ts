...
const createAdaptiveColors = () => {
  ...
  return {
    ...
    content: {
      ...
      // Additional content properties for compatibility
      primarySecondary: isDark ? "#B8B8B8" : "#666666", // For backward compatibility
    },

    // Award-winning shadow system
    shadow: {
      default: isDark ? "rgba(0, 0, 0, 0.7)" : "rgba(0, 0, 0, 0.1)",
      subtle: isDark ? "rgba(0, 0, 0, 0.5)" : "rgba(0, 0, 0, 0.05)",
      medium: isDark ? "rgba(0, 0, 0, 0.8)" : "rgba(0, 0, 0, 0.15)",
      strong: isDark ? "rgba(0, 0, 0, 0.9)" : "rgba(0, 0, 0, 0.25)",
    },
    ...
    accent: {
      ...
      primaryDark: "#E55528", // Legacy compatibility
...
const createAdvancedAnimations = () => ({
  ...
  spring: {
    ...
    elastic: {
      ...
      // Direct border access for compatibility  
    border: "#EEEEEE",
